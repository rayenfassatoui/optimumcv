...
export const createATSOptimizationPrompt = (cv: CVData): string => {
  return [
    ...
    "4. Quantify achievements with realistic, specific numbers where possible (e.g., 'Led team of 5', 'Increased efficiency by 30%', 'Managed $500K budget', 'Reduced costs by 25%')",
    "5. If exact metrics are not available, use realistic estimates based on the role level and industry standards",
    "6. NEVER use placeholder text like 'x%', 'X users', or 'N items' - always provide specific numbers",
    "7. Remove special characters, graphics descriptions, and complex formatting",
    "8. Use standard job titles and clear role descriptions",
    "9. Include relevant technical skills and tools",
    "10. Make content scannable with clear, concise language",
    "11. Ensure consistency in date formats and structure",
    "12. Optimize for keyword matching without 'keyword stuffing'.",
    "",
    "CRITICAL: When adding metrics:",
    "- For team size: Use realistic numbers like 'team of 5', 'team of 3-7 developers', etc.",
    "- For improvements: Use percentages like '20%', '35%', '50%' based on achievement type",
    "- For users/customers: Use realistic scale like '1,000+ users', '50K+ customers', '100+ clients'",
    "- For financial: Use appropriate scale like '$100K budget', '$2M revenue', etc.",
    "- If the original CV has no metrics, infer reasonable ones based on job level and responsibilities",
    "",
    ...
    "- Rewrite the summary and experience highlights to be keyword-rich, start with action verbs, and include SPECIFIC realistic metrics (never use placeholders).",
  ].join("\n")
}
